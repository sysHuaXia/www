...
namespace EF
{
    ...
    public partial class v_infolist
    {
        ...
        public Nullable<int> v_sqryId { get; set; }
        ...
        public string fp_PackageMail { get; set; }
        public string fp_CourierNumber { get; set; }
