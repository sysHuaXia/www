...
function chkk(TDID) {
    ...
    $.ajax({
        type: "POST",
        url: "/PersonalCenter/IndexNewAjax",
...
function BindSeachList(str) {
    ...
    tStr += '<td height="35" bgcolor="#FF8E8E" width="10%"><div align="center" style="color:#000000;">标准套餐</div></td>';
    tStr += '<td height="35" bgcolor="#FF8E8E" width="10%"><div align="center" style="color:#000000;">套餐+加急</div></td>';
    tStr += '<td height="35" bgcolor="#FF8E8E" width="10%"><div align="center" style="color:#000000;">加急套餐</div></td>';
    ...
    for (var i = 0; i < orders.length - 1 ; i++) {
        ...
        if (order[14] == 1) {
            ...
            tStr += '<td><span style="color:#CCC;" onclick="Sequestration();">操作</span></td>';
        }
...
//自动加载数据 
function BindIniCenterRoleData(CodeId, Year, Month, RoleId) {
