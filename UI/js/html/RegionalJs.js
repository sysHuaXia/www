...
function chrkk(TDID) {
    ...
    $.ajax({
        type: "POST",
        url: "/RegionalLists/RegionalAjax",
        ...
        success: function (sesponseTest) {
            ...
            if (sesponseTest == "") {
                ...
                BindSeachRegionalList(sesponseTest);
            }
        }
    });
}
...
//绑定搜索信息
function BindSeachRegionalList(str) {
    //分割字符串 &|
    ...
    tStr += '<td height="35" bgcolor="#FF8E8E" width="4%"><div align="center">ID</div></td>';
    tStr += '<td height="35" bgcolor="#FF8E8E" width="8%"><div align="center">姓名</div></td>';
    tStr += '<td height="35" bgcolor="#FF8E8E" width="8%"><div align="center">出签数</div></td>';
    tStr += '<td height="35" bgcolor="#FF8E8E" width="8%"><div align="center">拒签数</div></td>';
    tStr += '<td height="35" bgcolor="#FF8E8E" width="8%"><div align="center">退单数</div></td>';
    tStr += '<td height="35" bgcolor="#FF8E8E" width="12%"><div align="center" style="color:#000000;">标准套餐</div></td>';
    tStr += '<td height="35" bgcolor="#FF8E8E" width="12%"><div align="center" style="color:#000000;">套餐+加急</div></td>';
    tStr += '<td height="35" bgcolor="#FF8E8E" width="12%"><div align="center" style="color:#000000;">加急套餐</div></td>';
    tStr += '<td height="35" bgcolor="#FF8E8E" ><div align="center" style="color:#000000;">总份数</div></td>';
    tStr += '</tr>';
...
//自动加载数据 
function BindIniRegionalRoleData(CodeId, Year, Month, RoleId) {
...
function ShowUserByRoleId(SID) {
    ...
    $.ajax({
        ...
        success: function (sesponseTest) {
            if (sesponseTest != "0") {
                var str = '<dt>部门人员：</dt><dd class="select-all selected"><a href="javascript:void(0);" onclick="Seach(0,5);">全部</a></dd>';
