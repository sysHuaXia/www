...
function BindSeachList(str) {
    ...
    for (var i = 0; i < orders.length - 1; i++) {
        ...
        tStr += '<td style="text-align:center;">[' + order[11] + ']<br/>' + order[1] + '</td>';
        ...
        tStr += '<td style="text-align:center;">' + order[5] + '<br/>' + order[9] + '</td>';
        tStr += '<td style="text-align:center;">' + formatDate(order[7]) + '</td>';
        tStr += '<td style="text-align:left;font-size:14px;color:green"><span style="color:#CCC" onclick="ShowTagTicket(' + order[0] + ')">标记</span>&nbsp;&nbsp;<span style="color:blue;">' + order[10] + '</span>&nbsp;' + order[8] + '</td>';
        tStr += '</tr>';
