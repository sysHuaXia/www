...
function BindSeachList(str) {
    ...
    for (var i = 0; i < orders.length - 1; i++) {
        ...
        tStr += '<td style="text-align:center;">' + order[6] + '<br/>' + order[2] + '</td>';
        ...
        tStr += '<td style="text-align:left;"><span style="color:green;">' + order[9] + '</span><br/><span>' + order[10] + '</span><span style="color:#CCC" onclick="ShowTagExecutive(' + order[0] + ')">标记</span></td>';
        tStr += '</tr>';
